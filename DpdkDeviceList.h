...
namespace pcpp
{
	...
	class SNDpdkDeviceList
	{
		private:

		static uint8_t m_CoreMask;
		static uint8_t m_N;
		static uint8_t m_PortMask;
		static uint8_t m_RxQueue;
	...
	public:
		...
		static inline SNDpdkDeviceList& getInstance()
		{
			static SNDpdkDeviceList instance;
			return instance;
		}


		static int initDpdkStartThreads(uint8_t coremask, uint8_t paramn, uint8_t paramq, uint8_t paramp,std::vector<DpdkWorkerThread*>& workerThreadsVec);
